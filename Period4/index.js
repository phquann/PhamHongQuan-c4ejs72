...
// //     expectedHours: 0.5,
// //     }
// //     const { subject, dueDate, assignTo } = task; console.log(subject, dueDate, assignTo)
...
// //         console.log('benefits', data.hits[i].benefits)
// //     }
// // }
...
// // };
// // alert('Xin chào chúng mày đây là từ điển dành cho Dev')
// // for(i=0; i<Infinity; i++) {
// // let a = prompt('Nhập từ mày muốn dịch vào đây ?')
// // if (a in Dictionary) {
// //     alert(a +"\n" + Dictionary[a])
// //     } else {
// //     Dictionary[a] = prompt('Từ mày hỏi không thuộc chuyên môn của tao rồi, sorry :D')
// //     alert('Ok cảm ơn vì sự đóng góp của mày')
// //     }
// // }
...
// // }
// // let number = Number(prompt("Muốn số mấy thì nhập vào đây ?"));
// // let Product = products[number - 1];
// // for (const x in Product) {
// //   console.log(`${x} : ${Product[x]}`);
// // }
// //5.3
// // let a = prompt('Nhập loại sản phẩm mày muốn vào mau ?')
// // for(let i =0;i<products.length;i++)
// //     {
...
// //         } else {
// //             alert('Nhập clgt shop tao không bán cái đó')
// //         }
// //     }
// //5.4
// // products[0].provider = "phukienzero dientucc";
...
// // Bai6
// // console.log("Các cháu ơi.Hôm nay bà lại tiếp tục làm cờ líp.Bà sẽ dạy các cháu cách để trở thành 1 Dev thứ thiệt");
// // const tasks = [
// //   {
// //     task: "HTML",
// //     complete: false
...
// //   }
// // ];
// // const command = prompt("Nhập lệnh vào đây và làm ơn là 1 trong 4 cái sau (New,Update,Delete,Complete)").toLowerCase();
// // if (command === "new") {
// //   const newThing = prompt("Nhập công việc mới vào đây làm ơn?");
// //   const newTask = {
// //     task: newThing,
// //     complete: false
// //   };
...
// //   let index = Number(prompt("Muốn nhảy cóc bước nào mà xóa?"));
// //   tasks.splice(index - 1, 1);
// // } else if (command === "update") {
// //   let index = Number(prompt("Muốn cải tiến bước nào em ơi ?"));
// //   let newUpdate = prompt("Đâu cho anh xem sự cải tiến của em");
// //   tasks[index - 1].task = newUpdate;
// // } else if (command === "complete") {
// //   let index = Number(prompt("Thế m học xong cái nào rồi?"));
